...
miMoto=moto("Honda", "CBR") #Es una INSTANCIA

miMoto.caballito() #Si no llamo a este método, no se ejecuta y el valor devuelto en la llamada al metodo estado será ""
